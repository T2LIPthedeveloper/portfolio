  ...
  return (
    <>
      ...
      <motion.header
        initial={false}
        animate={{
          width: scrolled ? "min(720px, calc(100vw - 2rem))" : "min(1100px, calc(100vw - 2rem))",
        }}
        transition={{ duration: 0.35, ease: [0.22, 1, 0.36, 1] }}
        className="fixed left-1/2 top-4 z-50 -translate-x-1/2"
      >
        <nav className="glass flex items-center justify-between gap-3 rounded-full px-4 py-2 shadow-lg md:gap-4 md:px-6">
      ...
      {open && (
        <div
          ...
          style={{ backgroundColor: "color-mix(in srgb, var(--color-canvas) 95%, transparent)" }}
        >
